      ...
      <div class="form-auth-bg row justify-content-center align-self-center">
        ...
        <form method="POST">
          ...
          <div class="form-floating">
            <input class="form-control" type="text" placeholder="Name" id="name" class="form-control"
              name="name" required autofocus>
            <label for="name">Name</label>
          </div>
          <div class="form-floating">
            <input class="form-control" type="text" placeholder="Email" id="email" class="form-control"
              name="email" required>
            <label for="email">Email address</label>
          </div>
          <div class="form-floating">
            <input class="form-control" type="password" placeholder="Password" id="password" class="form-control"
