        ...
        <div class="col-md-6">
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col p-3 d-flex flex-column position-static">
              ...
              <h3 class="mb-1">Title/Name</h3>
              <div class="mb-1 text-muted">Last updated</div>
              <p class="card-text mb-2">Small description like 110 words so it fits the size of the card and still looks
                nice but still is descriptive</p>
